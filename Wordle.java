...
Purpose of java application: To allow the user to run the game Wordle (Credit: https://www.nytimes.com/games/wordle/index.html) in their terminal using the offical wordle word list (Credit: https://gist.github.com/cfreshman/a03ef2cba789d8cf00c08f767e0fad7b)
*/
...
public class Wordle
{
  ...
  private void printInstructions()
  {
    ...
    System.out.println("Welcome to Wordle (Java-Version)! Within Wordle, you will have 6 chances to guess a random 5 letter word. However, this game will try to guide you toward to correct answer upon every of your incorrect answers. Anytime you answer a word, some letters within your word may be colored. The letters that aren't colored are not all within the word you are trying to guess. The words colored in cyan, however, are in the word you are trying to guess, however, the spot in which you placed the letter is incorrect. Lastly, any letter colored in green is in the word you are trying to guess and is in the correct spot. If you do not guess the word within 6 guesses though, the word you were trying to guess will be revealed. Good luck and have fun.");
